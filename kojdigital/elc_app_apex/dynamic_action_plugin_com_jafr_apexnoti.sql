...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(573133443653705817)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(573139470024766362)
,p_plugin_id=>wwv_flow_api.id(573133443653705817)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(573140082716768106)
,p_plugin_attribute_id=>wwv_flow_api.id(573139470024766362)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(573140500306769172)
,p_plugin_attribute_id=>wwv_flow_api.id(573139470024766362)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(573142494685881170)
,p_plugin_id=>wwv_flow_api.id(573133443653705817)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(548449411795213718)
,p_plugin_id=>wwv_flow_api.id(573133443653705817)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(573145532431944075)
,p_plugin_id=>wwv_flow_api.id(573133443653705817)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(559383857170292909)
,p_plugin_id=>wwv_flow_api.id(573133443653705817)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(559384539048300904)
,p_plugin_id=>wwv_flow_api.id(573133443653705817)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(559376068276207220)
,p_plugin_id=>wwv_flow_api.id(573133443653705817)
